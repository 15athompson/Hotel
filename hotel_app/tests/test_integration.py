...
class RoomAvailabilityIntegrationTestCase(TestCase):
    ...
    def test_overlapping_reservations(self):
        """Test that overlapping reservations are properly handled making the call at the view level"""
        self.client.login(username='testuser', password='testpass123')
        ...
        #with self.assertRaisesMessage(ValidationError, "This room is already booked for the entered dates."):
